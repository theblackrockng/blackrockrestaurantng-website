...
export default function Gallery() {
  ...
  return (
    <div className="page-enter pt-24">
      ...
      {/* Filter */}
      <section className="bg-[var(--warm-white)] pb-8">
      ...
      {/* Grid - Masonry-ish */}
      <section className="bg-[var(--warm-white)] pb-24 md:pb-32" data-testid="gallery-grid">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-5">
            {filtered.map((g, i) => (
              <motion.button
                ...
                className={`img-hover relative cursor-pointer overflow-hidden ${
      ...
      {/* Two concepts */}
      <section className="bg-[var(--charcoal)] text-[var(--warm-white)] py-24 md:py-32" data-testid="concepts-section">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12">
          <SectionHeader kicker="Two Faces" title="Daylight & After Dark." dark />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
            {[
              ...
              { img: IMAGES.rooftopNight, title: "After Dark", desc: "Lit by candles and fire pits. The city below, the night above, you in between." },
            ].map((c) => (
      ...
      {/* CTA */}
      <section className="bg-[var(--warm-white)] py-24 text-center" data-testid="gallery-cta">
